...
Consider the function $f(x) = 2x^2 + 2x - 1$. Find the average rate of change in $f$ over each of the following intervals. Show all significant steps; if your answer is a fraction, simplify the fraction completely but do not convert to a decimal. 
