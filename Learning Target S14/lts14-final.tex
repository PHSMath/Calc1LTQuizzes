...
A particle moves along a straight line so that its velocity at time $t$ is $v(t) = t^2 - t -6$ meters per second. Find the total change in the position of the particle during the time period $4 \leq t \leq 6$.\\
